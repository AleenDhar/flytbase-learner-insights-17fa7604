...
const Navigation = () => {
  ...
  return (
    <nav className="w-full bg-white/90 backdrop-blur-md shadow-sm fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative ml-3">
              <button
                ...
                className="flex items-center text-sm font-medium text-neutral-800 hover:text-flytbase-primary focus:outline-none"
              >
                <span className="sr-only">Open user menu</span>
                <div className="h-8 w-8 rounded-full bg-flytbase-primary flex items-center justify-center text-white">
          ...
          <div className="flex items-center md:hidden">
            <button
              onClick={toggleProfile}
              className="mr-2 flex items-center justify-center rounded-full bg-flytbase-primary p-1.5 text-white"
            >
              <span className="sr-only">Open user menu</span>
              <User className="h-5 w-5" />
            </button>
            ...
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-md text-flytbase-primary hover:text-flytbase-primary/90 hover:bg-neutral-100 focus:outline-none"
            >
      ...
      {/* Mobile Profile Menu */}
      {isProfileOpen && (
        <div className="md:hidden border-t border-neutral-200 pt-4 pb-3 animate-fade-in">
          <div className="flex items-center px-4">
            <div className="flex-shrink-0">
              <div className="h-10 w-10 rounded-full bg-flytbase-primary flex items-center justify-center text-white">
                <User className="h-6 w-6" />
              </div>
            </div>
            <div className="ml-3">
              <div className="text-base font-medium text-neutral-800">John Doe</div>
              <div className="text-sm font-medium text-neutral-500">john.doe@example.com</div>
            </div>
          </div>
          <div className="mt-3 space-y-1">
            <a
              href="#"
              className="block px-4 py-2 text-base font-medium text-neutral-700 hover:bg-neutral-100 flex items-center"
            >
